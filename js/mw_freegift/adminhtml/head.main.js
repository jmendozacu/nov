...
MW.FreeGift.SystemConfig.Caltax = Class.create();

MW.FreeGift.SystemConfig.Caltax.prototype =
{
    ...
    _: function(value)
    {
        ...
        {
            $("row_rewardpoints_config_redeemed_tax").hide();
            $("row_rewardpoints_config_redeemed_shipping").hide();
        }
        else if(value == this.params.AFTER_VALUE)
        {
            $("row_rewardpoints_config_redeemed_tax").show();
            $("row_rewardpoints_config_redeemed_shipping").show();
        }
    }
};

MW.FreeGift.Report.Dashboard = Class.create();
MW.FreeGift.Report.Dashboard.prototype = {
    initialize: function(params){
        var self = this;
        this.params = params;
        ...
        new Ajax.Request(this.params.url, {
            ...
            onSuccess: function(transport){
                if(transport.responseText){
                    ...
                    console.log('ko phai click refresh');
                }else{
                    /** Draw empty grah */
                }
            }
    ...
    fillDataStats: function(data){
        $("total_order").innerHTML = data.total_order;
        $("total_gift").innerHTML = data.total_gift;
        $("avg_gift_customer").innerHTML = data.avg_gift_per_customer;
        $("avg_gift_order").innerHTML = data.avg_gift_per_order;
    },
    ...
    buildOptionChart: function(type){
        ...
        var currency = $('freegiftsymbol').value;
        this.series = [{
