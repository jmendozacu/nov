...
class MW_FreeGift_Helper_Configurable extends Mage_Catalog_Block_Product_View_Type_Configurable{
    /**
     * Prices
     *
     * @var array
    ...
    public function getAllowProducts()
    {
        if (!$this->hasAllowProducts()) {
            $products = array();
            $skipSaleableCheck = (method_exists(Mage::helper('catalog/product'), 'getSkipSaleableCheck')) ? Mage::helper('catalog/product')->getSkipSaleableCheck() : true;
