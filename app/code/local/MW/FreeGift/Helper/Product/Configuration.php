<?php
class MW_FreeGift_Helper_Product_Configuration extends Mage_Catalog_Helper_Product_Configuration
{
	...
	{			
		$str = "";	
		$value_print = "";			
		if($optionValue['label'] == "Free Gift"){
			$str = "FreeGift";
			$value_print = $optionValue['print_value'];		
		}
		// Init params
		if (!$params) {
			$params = array();
