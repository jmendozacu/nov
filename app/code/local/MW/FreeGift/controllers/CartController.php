...
class MW_FreeGift_CartController extends Mage_Checkout_CartController
{
    ...
    public function updatePostAction()
    {
        ...
        if($google_plus == '' || $google_plus == null){

        }else{
            Mage::getSingleton('checkout/session')->setGooglePlus($google_plus);
        }

        $like_fb = $params['like_fb'];
        if($like_fb == '' || $like_fb == null){

        }else{
            Mage::getSingleton('checkout/session')->setLikeFb($like_fb);
        }

        $share_fb = $params['share_fb'];
        if($share_fb == '' || $share_fb == null){

        }else{
            Mage::getSingleton('checkout/session')->setShareFb($share_fb);
        }
        ...
        if($twitter == '' || $twitter == null){
            ...
            Mage::getSingleton('checkout/session')->setTwitter($twitter);
        }
