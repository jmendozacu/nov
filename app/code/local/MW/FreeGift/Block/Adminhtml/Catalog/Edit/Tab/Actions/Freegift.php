<?php
class MW_FreeGift_Block_Adminhtml_Catalog_Edit_Tab_Actions_Freegift extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return Mage::registry('current_gift_catalog_rule');
    }
