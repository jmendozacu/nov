<?php
class MW_FreeGift_Block_Adminhtml_Quote_Edit_Tab_Main
...
implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
	...
	*/
	...
	protected function _prepareForm()
	{
		...
		$fieldset->addField('promotion_message', 'textarea', array(
			'name' => 'promotion_message',
			'label' => Mage::helper('freegift')->__('Promotion Message'),
			'title' => Mage::helper('freegift')->__('Promotion Message'),
			'style' => 'width: 98%; height: 100px;',
		));
		
		$fieldset->addField('promotion_banner', 'image', array(
			'label'     => Mage::helper('freegift')->__('Promotion Banner'),                
			'required'  => false,
		...
		$this->getLayout()->createBlock('freegift/adminhtml_quote_edit_tab_renderer_checkbox')
			);
		
		$usesPerCouponFiled = $fieldset->addField('uses_per_coupon', 'hidden', array(
		...
		Mage::dispatchEvent('freegift_quote_edit_tab_main_prepare_form', array('form' => $form));
