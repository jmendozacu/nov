...
class MW_FreeGift_Model_Quote extends Mage_Sales_Model_Quote{
    ...
    public function addProductAdvanced(Mage_Catalog_Model_Product $product, $request = null, $processMode = null)
    {
        ...
        foreach ($cartCandidates as $candidate) {
            ...
            if($candidate->getParentProductId()){
                /** if this product has parent, then add qty based parent product (product type: configable, bundle, grouped..) */
                $item->addQty(1);
            }else{
                /** if this product havent parent (product type: simple product) */
                $item->addQty(1);
