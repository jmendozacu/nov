...
class MW_FreeGift_Model_Observer_Layout extends Mage_Core_Model_Abstract{
    ...
    public function controllerLayoutBefore(Varien_Event_Observer  $observer){
        ...
        if(Mage::getDesign()->getArea() == 'frontend'){
            ...
            $js .= "var mw_post_baseUrl = '".$base_url.(empty($store_view) ? "" : $store_view."/")."';\n";
...
window.freegiftConfig = {
    url: {
        add                                 : '".Mage::getUrl('freegift/cart/addg', $paramHttps)."',
        configure                           : '".Mage::getUrl('freegift/cart/configure', $paramHttps)."',
        getproduct                          : '".Mage::getUrl('freegift/cart/getproduct', $paramHttps)."',
        updatePost                          : '".Mage::getUrl('freegift/cart/updatePost', $paramHttps)."',
        delete                              : '".Mage::getUrl('freegift/cart/delete', $paramHttps)."',
        cart                                : '".Mage::getUrl('freegift/cart', $paramHttps)."'
    },
};\n";
